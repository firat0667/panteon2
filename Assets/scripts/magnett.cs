...
public class magnett : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (distance<12)
        {
            enemy.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
      else if(distance2 <12)
        {
            playerr.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance3 < 12)
        {
            playerr2.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance4 < 12)
        {
            enemy2.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance5 < 12)
        {
            enemy3.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance6 < 12)
        {
            enemy4.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance7 < 12)
        {
            enemy5.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance8 < 12)
        {
            enemy6.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance9 < 12)
        {
            enemy7.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance10 < 12)
        {
            enemy8.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance11 < 12)
        {
            enemy9.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
        else if (distance12 < 12)
        {
            enemy10.GetComponent<Rigidbody>().AddForce(Vector3.right * 500f);
        }
